    ...
    fileprivate func audioSubmenu() -> UIMenu {
        func children() -> [UIMenuElement] {
            let audioInputMenuChildren = [
                (title: "Auto", value: 0), (title: "Disabled", value: 1), (title: "Static Noise", value: 2), (title: "OpenAL", value: 4)
            ]
            
            let audioOutputMenuChildren = [
                (title: "Auto", value: 0), (title: "Disabled", value: 1), (title: "OpenAL", value: 3), (title: "SDL2", value: 4)
            ]
