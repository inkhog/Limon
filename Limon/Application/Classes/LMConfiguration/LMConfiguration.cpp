...
#include "LMDefaultConfiguration.h"
...
LMConfiguration::~LMConfiguration() = default;

bool LMConfiguration::LoadINI(const std::string& default_contents, bool retry) {
...
static const std::array<int, Settings::NativeButton::NumButtons> default_buttons = {
    LMInputManager::N3DS_BUTTON_A,     LMInputManager::N3DS_BUTTON_B,
    LMInputManager::N3DS_BUTTON_X,     LMInputManager::N3DS_BUTTON_Y,
    LMInputManager::N3DS_DPAD_UP,      LMInputManager::N3DS_DPAD_DOWN,
    LMInputManager::N3DS_DPAD_LEFT,    LMInputManager::N3DS_DPAD_RIGHT,
    LMInputManager::N3DS_TRIGGER_L,    LMInputManager::N3DS_TRIGGER_R,
    LMInputManager::N3DS_BUTTON_START, LMInputManager::N3DS_BUTTON_SELECT,
    LMInputManager::N3DS_BUTTON_DEBUG, LMInputManager::N3DS_BUTTON_GPIO14,
    LMInputManager::N3DS_BUTTON_ZL,    LMInputManager::N3DS_BUTTON_ZR,
    LMInputManager::N3DS_BUTTON_HOME,
};

static const std::array<int, Settings::NativeAnalog::NumAnalogs> default_analogs{{
    LMInputManager::N3DS_CIRCLEPAD,
    LMInputManager::N3DS_STICK_C,
}};

void LMConfiguration::UpdateCFG() {
...
template <>
void LMConfiguration::ReadSetting(const std::string& group, Settings::Setting<std::string>& setting) {
...
template <>
void LMConfiguration::ReadSetting(const std::string& group, Settings::Setting<bool>& setting) {
    setting = sdl2_config->GetBoolean(group, setting.GetLabel(), setting.GetDefault());
}

template <typename Type, bool ranged>
void LMConfiguration::ReadSetting(const std::string& group, Settings::Setting<Type, ranged>& setting) {
...
void LMConfiguration::ReadValues() {
    // Controls
    for (int i = 0; i < Settings::NativeButton::NumButtons; ++i) {
        std::string default_param = LMInputManager::GenerateButtonParamPackage(default_buttons[i]);
    ...
    for (int i = 0; i < Settings::NativeAnalog::NumAnalogs; ++i) {
        std::string default_param = LMInputManager::GenerateAnalogParamPackage(default_analogs[i]);
...
void LMConfiguration::Reload() {
    LoadINI(LMDefaultConfiguration::sdl2_config_file);
    ReadValues();
}
