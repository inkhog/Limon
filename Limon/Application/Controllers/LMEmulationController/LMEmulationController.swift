...
class LMEmulationController : UIViewController {
    ...
    var vulkanScreenView = LMVulkanScreenView(frame: UIScreen.main.bounds)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touch.view == vulkanScreenView.screen {
            citra().touchesBegan(point: touch.location(in: vulkanScreenView.screen))
        }
    }
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touch.view == vulkanScreenView.screen {
            citra().touchesMoved(point: touch.location(in: vulkanScreenView.screen))
        }
    }
    ...
    override func viewDidLayoutSubviews() {
        ...
        if !citra().isRunning() {
            citra().setVulkanLayer(vulkanScreenView.screen.layer as! CAMetalLayer)
    ...
    override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        citra().setVulkanOrientation(UIDevice.current.orientation, with: vulkanScreenView.screen.layer as! CAMetalLayer)
    }
