...
enum TextureFilter : Int, CustomStringConvertible {
    case off = 0, anime4K = 1, bicubic = 2, scaleForce = 3, xbrz = 4, mmpx = 5
    static let filters = [off, anime4K, bicubic, scaleForce, xbrz, mmpx]
...
enum TextureSampling : Int, CustomStringConvertible {
    case gameControlled = 0, nearestNeighbor = 1, linear = 2
    static let samples = [gameControlled, nearestNeighbor, linear]
...
enum FrameLimit : Int, CustomStringConvertible {
    case r100 = 100, r90 = 90, r80 = 80, r70 = 70, r60 = 60, r50 = 50
    // 240, 480, 720, 960, 1200, 1440
    static let limits = [r100, r90, r80, r70, r60, r50]
...
@objc class EmulationSettings : NSObject {
    ...
    @objc static var textureSampling: Int = UserDefaults.standard.integer(forKey: "textureSampling")
    ...
    override init() {
        ...
        EmulationSettings.textureSampling = UserDefaults.standard.integer(forKey: "textureSampling")
