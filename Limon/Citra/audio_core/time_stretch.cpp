...
std::size_t TimeStretcher::Process(const s16* in, std::size_t num_in, s16* out,
    ...
    sound_touch->putSamples((soundtouch::SAMPLETYPE*)in, static_cast<u32>(num_in));
    return sound_touch->receiveSamples((soundtouch::SAMPLETYPE*)out, static_cast<u32>(num_out));
    
    // MARK: (Citra) this is really bad for iOS – Antique
    /*
